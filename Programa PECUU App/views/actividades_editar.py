...
from components.actividades_editar import handle_save

class ActividadesEditar(ft.Container):
    """
    Representa la vista de "Actividades - Editar" de la aplicación.

    Hereda de ft.Container y se configura para ocupar toda el área de contenido
    principal de la aplicación.
    """
    def __init__(self, page: ft.Page, change_view=None, update_actividad_callback=None):
        """
        ...
        :param update_actividad_callback: Función callback para actualizar una actividad.
        :type update_actividad_callback: callable
        """
        super().__init__()
        self.flet_page = page  # Guardar la referencia a la página de Flet
        self.change_view = change_view
        self.update_actividad_callback = update_actividad_callback
        self.actividad_index = None
        self.actividad_data = None
        ...
        self.flet_page.overlay.append(self.fecha_picker)
        ...
        self.content = ft.Column(
            ...
            controls=[
                InnerHeader("EDITAR ACTIVIDAD", icon=ft.Icons.EDIT),
                ft.Column(
                    alignment=ft.MainAxisAlignment.START,
                    width=700,
                    controls=[
                        ...
                        ft.Row(
                            ...
                            controls=[
                                ...
                                ft.ElevatedButton(
                                    ...
                                    on_click=lambda e: self.flet_page.open(self.fecha_picker)
                                ),
                                self.fecha_display
                            ]
                        ),
    ...
    def set_actividad(self, actividad_index, actividad_data):
        """
        Establece los datos de la actividad a editar.
        
        :param actividad_index: Índice de la actividad
        :param actividad_data: Datos de la actividad
        """
        self.actividad_index = actividad_index
        self.actividad_data = actividad_data
        
        # Llenar los campos con los datos actuales
        self.titulo_textfield.value = actividad_data.get("titulo", "")
        self.descripcion_textfield.value = actividad_data.get("descripcion", "")
        self.usuario_dropdown.value = actividad_data.get("usuario", "")
        self.fecha_display.value = actividad_data.get("fecha", "Seleccionar Fecha")
